...
namespace nw {
	...
	public:
		...
		static _CONSTEXPR17 inline Ty map_scale(const Ty input, const Ty input_low, const Ty input_high) {
		...
		static _CONSTEXPR17 inline Ty map_unscale(const Ty scale, const Ty output_low, const Ty output_high) {
		...
		static _CONSTEXPR17 inline Ty map(const Ty input, const Ty input_low, const Ty input_high, const Ty output_low, const Ty output_high) {
			const Ty scale = map_scale(input, input_low, input_high);

			return map_unscale(scale, output_low, output_high);
		}

		static _CONSTEXPR17 inline Ty map_reverse(const Ty input, const Ty low, const Ty high) {
